const { findMean, findMedian, findMode } = require('./maths');

describe("#findMedian", function(){
    it("finds the median of an even set", function(){ 
      expect(findMedian([4, -2, 6, 2])).toEqual(1.5)
    })
    it("finds the median of an odd set", function () { 
      expect(findMedian([1, -1, 6])).toEqual(1)
    })
  })
  ...
  describe("#findMean", function () {
    ...
    it("finds the mean of an array of numbers", function () { 
      expect(findMean([1,-1,6,4])).toEqual(1.5)
    })
  })
